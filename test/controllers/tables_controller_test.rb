...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference("Table.count") do
      post tables_url, params: { table: { league_id: @table.league_id, logo: @table.logo, name: @table.name, points: @table.points } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { league_id: @table.league_id, logo: @table.logo, name: @table.name, points: @table.points } }
